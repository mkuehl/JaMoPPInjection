...
public class ClassChanges {
	 ...
	 * p_qualifiedClassName has just to correspond to (package.)+class (at least one 
	 * package and a class name).
	 *
	 ...
	 * @param p_changes
	 */
	public ClassChanges(String p_qualifiedClassName, int p_beginningLine, byte p_addRem, 
